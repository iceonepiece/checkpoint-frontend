...
import FolderSidebar from "@/components/FolderSidebar"; // 1. Import Sidebar
...
export default function AssetPage(props: Params) {
  ...
  return (
    <div className="flex h-full">
      ...
      {/* MAIN CONTENT AREA */}
      <section className="flex-1 h-full w-full overflow-y-auto min-w-0">
